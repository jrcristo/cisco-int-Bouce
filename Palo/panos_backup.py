...
fwkey = "LUFRPT1rbWJOQkJaNjBxVjlJYkVpWU1ZTmoxNVhFMEk9Z2UrTExsTzArcTBSaEM4cFpad2p1dz09"
...
filename = datetime.datetime.fromtimestamp(time.time()).strftime(fwhost + "_" + '%Y%m%d%H%M%S') + '.xml'
