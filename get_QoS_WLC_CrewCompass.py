...
print('==> script to show QoS per WLAN on CrewCompass<==')
...
if __name__ == '__main__':
    ...
    all_wlc = input("==> do you want to check CrewCompass in one SHIP or all, (Y) to ONE (N) to all:").lower()
    if all_wlc in yes_option:
        ...
        try:
            if ex.group():
                ...
                # showing QoS
                funtions_jose.get_wlc_wlan_qos_crewcompass(net_connect)
